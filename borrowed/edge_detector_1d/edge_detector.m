function [ dData, minmax, stats ] = edge_detector( data, scales, thresholds, timestep, startTime, endTime, tranRad )
...
% this is a modified version of AnalyzeEdges, which is part of the 1D Edge
% Detector package available from Center for the Computer Integrated
% Systems for Microscopy and Manipulation (CISMM) at UNC Chapel Hill
